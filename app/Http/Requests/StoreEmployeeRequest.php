...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Security & Account
            'employee_id' => ['required', 'string', 'max:50', 'unique:xin_employees,employee_id'],
            'card_no' => ['nullable', 'string', 'max:50'],
            'username' => ['nullable', 'string', 'max:50', 'unique:xin_employees,username'],
            'email' => ['required', 'email', 'max:150', 'unique:xin_employees,email', 'unique:users,email'],
