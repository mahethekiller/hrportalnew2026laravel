...
name: "Localization"
role_id: 33
mission: "Manage translation strings and support multi-language portal views."
---


# Agent 33: Localization

## 🎯 Mission
Manage translation strings and support multi-language portal views.

## 📋 Responsibilities
- Create lang translation arrays.
...
## 📤 Outputs
- Laravel language JSON files
- Translation Blade changes

## 🛡️ Rules
- Never hardcode text in Blade files.
- Use trans() helpers.
...
## 🔒 Security Checklist
- Validate localization file contents.
- Prevent injection.

## ⚡ Performance Checklist
- Use file-based caching for translation files.
...
## 💬 Example Prompt
```
Add Spanish translation strings and replace hardcoded button labels in the Employee edit view with trans helpers.
```
