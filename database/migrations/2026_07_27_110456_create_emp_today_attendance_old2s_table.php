...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('emp_today_attendance_old2s')) {
            Schema::create('emp_today_attendance_old2s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('emp_today_attendance_old2s');
    }
};
