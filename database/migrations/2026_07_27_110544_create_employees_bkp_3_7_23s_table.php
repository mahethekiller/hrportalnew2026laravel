...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('employees_bkp_3_7_23s')) {
            Schema::create('employees_bkp_3_7_23s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('probation_status')->default('Probation');
    ...
    {
        Schema::dropIfExists('employees_bkp_3_7_23s');
    }
};
