...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('employee_terminations_logs')) {
            Schema::create('employee_terminations_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('employee_terminations_logs');
    }
};
