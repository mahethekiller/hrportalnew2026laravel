...
<div class="row mb-4 align-items-center">
    <div class="col-sm-6">
        <h4 class="mb-0 text-gray-900 fw-bold"><i class="fa-solid fa-ticket-simple me-2 text-primary"></i> Admin Support Tickets</h4>
        <p class="text-muted fs-8 mb-0">File internal requests with administration and track resolution.</p>
    </div>
    <div class="col-sm-6 text-sm-end mt-2 mt-sm-0">
        <a href="{{ route('admin-tickets.create') }}" class="btn btn-primary btn-sm fw-bold">
            <i class="fa-solid fa-plus me-1"></i> Open Admin Ticket
        </a>
    </div>
</div>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-5 text-muted">
                                ...
                                No Admin support tickets logged.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
