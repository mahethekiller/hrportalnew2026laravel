...
<div class="row mb-4">
    <div class="col-sm-6">
        <h4 class="mb-0 text-gray-900 fw-bold"><i class="fa-solid fa-ticket-simple me-2 text-primary"></i> Open HR Support Ticket</h4>
        <p class="text-muted fs-8 mb-0">Submit a support request to HR.</p>
    </div>
        ...
        <form method="POST" action="{{ route('hr-tickets.store') }}">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-12">
                    ...
                    <input type="text" name="subject" class="form-control form-control-sm" required placeholder="e.g. Compensation Query / Policy Clarification" value="{{ old('subject') }}">
                    @error('subject')
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                <a href="{{ route('hr-tickets.index') }}" class="btn btn-light btn-sm">Cancel</a>
                <button type="submit" class="btn btn-primary btn-sm fw-bold">Submit HR Ticket</button>
            </div>
        </form>
    </div>
</div>
