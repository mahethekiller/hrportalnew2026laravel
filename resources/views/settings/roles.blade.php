                        ...
                        <div class="mb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm align-middle fs-8">
                                    ...
                                    <tbody>
                                        @php
                                            $availableResources = ['employees', 'organization', 'leave', 'attendance', 'payroll', 'performance', 'assets', 'recruitment', 'training', 'support_tickets', 'settings', 'api_control', 'reports'];
